...
export const API_ROUTES = {
  ...
  GUILD_WELCOME_CARD_PREVIEW: (id: string) =>
    `/guilds/${id}/welcome-card-preview`,
  ...
  GUILD_MEMORY_FROM_PROMPT: (id: string) =>
    `/guilds/${id}/memories/from-prompt`,

  MUSIC_STATE: (guildId: string) => `/v1/discord/music/guilds/${guildId}/state`,
  MUSIC_PLAY: (guildId: string) => `/v1/discord/music/guilds/${guildId}/play`,
  MUSIC_PAUSE: (guildId: string) => `/v1/discord/music/guilds/${guildId}/pause`,
  MUSIC_RESUME: (guildId: string) =>
    `/v1/discord/music/guilds/${guildId}/resume`,
  MUSIC_SKIP: (guildId: string) => `/v1/discord/music/guilds/${guildId}/skip`,
  MUSIC_PREV: (guildId: string) => `/v1/discord/music/guilds/${guildId}/prev`,
  MUSIC_VOLUME: (guildId: string) =>
    `/v1/discord/music/guilds/${guildId}/volume`,
  MUSIC_LOOP: (guildId: string) => `/v1/discord/music/guilds/${guildId}/loop`,
  MUSIC_SHUFFLE: (guildId: string) =>
    `/v1/discord/music/guilds/${guildId}/shuffle`,
  MUSIC_SEEK: (guildId: string) => `/v1/discord/music/guilds/${guildId}/seek`,
  MUSIC_QUEUE: (guildId: string) => `/v1/discord/music/guilds/${guildId}/queue`,
  ...
  MUSIC_JOIN: (guildId: string) => `/v1/discord/music/guilds/${guildId}/join`,
